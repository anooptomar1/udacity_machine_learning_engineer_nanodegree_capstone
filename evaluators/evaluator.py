...
import sketch_recognition_trainer
...
class Evaluator(object):
    ...
    def validate_params(self, params):
        ...
        if sketch_recognition_trainer.ParamKeys.TRAINING_SIZE not in params:
            raise Exception("Missing params parameter 'train_size'")

        if sketch_recognition_trainer.ParamKeys.TEST_SIZE not in params:
            raise Exception("Missing params parameter 'test_size'")

        if sketch_recognition_trainer.ParamKeys.FEATURE_EXTRACTOR not in params:
            raise Exception("Missing params parameter 'feature_extractor'")

        if sketch_recognition_trainer.ParamKeys.NUM_CLUSTERS not in params:
            raise Exception("Missing params parameter 'num_clusters'")

        if sketch_recognition_trainer.ParamKeys.FEATURE_COUNT not in params:
            raise Exception("Missing params parameter 'feature_count'")

        if sketch_recognition_trainer.ParamKeys.CLASSIFIER not in params:
